...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Kategori Penilaian</h1>
                <p class="text-gray-600 mt-1">Buat kategori baru untuk penilaian umpan balik</p>
            </div>
            ...
            <form action="{{ route('admin.kategori.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="nama_kategori" name="nama_kategori" required
                        ...
                        placeholder="Contoh: Kualitas Makanan">
                    @error('nama_kategori')
                ...
                <div>
                    ...
                    <textarea id="keterangan" name="keterangan" rows="3"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon-500 focus:border-maroon-500 @error('keterangan') border-red-500 @enderror"
